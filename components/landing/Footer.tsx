      ...
      <div className="footer-top">
        ...
        <div>
          ...
          <div className="footer-stores">
            <div className="store-badge">
              ...
              <span className="store-badge-soon">Soon</span>
            </div>
            <div className="store-badge">
              <PlayIcon />
              <div className="store-badge-text">
        ...
        <div className="footer-right">
          ...
          <div className="footer-socials">
            <a href="https://www.instagram.com/vaastio/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
              <IconInstagram />
            </a>
            <a href="https://linkedin.com/company/vaastio" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="LinkedIn">
              <IconLinkedIn />
            </a>
            <a href="https://twitter.com/vaastio" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Twitter">
              <IconTwitter />
            </a>
            <a href="mailto:info@vaastio.com" className="social-icon" aria-label="Email">
              <IconMail />
            </a>
          </div>
        </div>
